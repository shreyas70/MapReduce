...
void Reducer::word_count_request(string job_id, int category, string file_path, int no_of_mappers)
{
    int sock = this->reducer_socket;
    string request_type = "word_count";
    string wc_details = job_id+"$"+to_string(category)+"$"+file_path+"$"+to_string(no_of_mappers);
...
void Reducer::inverted_index_request(string job_id, int category, string file_path, int no_of_mappers)
{
    int sock = this->reducer_socket;
